      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="text-center mb-10">
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gold-gradient flex items-center justify-center">
            <LogIn className="text-charcoal" size={36} />
          </div>
          <h1 className="text-3xl font-bold text-gold-gradient mb-2">Золотая Ложка</h1>
          <p className="text-muted text-sm">Премиальный ресторан</p>
        </div>
